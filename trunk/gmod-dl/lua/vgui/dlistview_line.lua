...
Derma_Hook( PANEL, 	"Paint", "Paint", "ListViewLabel" )
Derma_Hook( PANEL, 	"ApplySchemeSettings", "Scheme", "ListViewLabel" )
Derma_Hook( PANEL, 	"PerformLayout", "Layout", "ListViewLabel" )
