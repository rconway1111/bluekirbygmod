...
function gmsave.ShouldSaveEntity( ent, t )
	...
	//
	// You can prevent certain entities from saving with ent:SetShouldToyboxSave( false )
	//
	if ( !ent:ShouldToyboxSave() ) then return false end
	...
	if ( IsValid( parent ) ) then
		return gmsave.ShouldSaveEntity( parent, parent:GetSaveTable() )
	end
