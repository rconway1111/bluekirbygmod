...
hook.Add( "PopulateToolMenu", "AddPostProcessMenu_ToyTown", function() spawnmenu.AddToolMenuOption( "PostProcessing", "PPShader", "ToyTown", "#Toy Town", "", "", BuildControlPanel, { SwitchConVar = "pp_toytown" } ) end )