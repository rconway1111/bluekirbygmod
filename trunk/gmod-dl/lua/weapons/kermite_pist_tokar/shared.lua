...
SWEP.ViewModel				= "models/weapons/v_pist_tokar.mdl"
SWEP.WorldModel				= "models/weapons/w_pist_tokar.mdl"
SWEP.Category			= "Kermite's Pistols Weapons"
SWEP.Primary.Sound 		= Sound("weapons/tokarev/tok.wav")
...
self.Weapon:EmitSound("weapons/1911/magrel.wav")
