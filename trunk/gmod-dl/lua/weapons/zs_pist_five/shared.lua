...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "ZS Pistol fiveseven"			-- The Name Of Your SWEP
...
SWEP.ViewModel			= "models/weapons/v_pist_fiveseven.mdl"		-- what it looks like <refer to model names> READ THE NOTE AT THE TOP IT
SWEP.WorldModel			= "models/weapons/w_pist_fiveseven.mdl"  	-- what it looks like <refer to model names> READ THE NOTE AT THE TOP IT
...
SWEP.Primary.Sound			= Sound( "Weapon_fiveseven.Single" )	-- Sound Of The Swep <refer to model names>
SWEP.Primary.Recoil			= 0.6						-- Recoil, How Much It Pushes Back
SWEP.Primary.Damage			= 25						-- Damage Of Each Shot
SWEP.Primary.NumShots		= 1							-- How Many Bullets Come Out Of The Gun At Once, A Shotgun Is 5 Where A Normal Gun Is 1
SWEP.Primary.Cone			= 0.012						-- Spread, A Shotgun Is 0.1, A Normal Gun Is Around 0.03
SWEP.Primary.ClipSize		= 12							-- How Many Bullets In A Clip	
SWEP.Primary.Delay			= 0.28					-- Time Inbetween Each Bullet(s), In Seconds
SWEP.Primary.DefaultClip	= 12						-- Ammo You Got Left
