...
if ( CLIENT ) then
	...
	local function UpdateUI()
		...
		local Panel = GetControlPanel( "Undo" )
	...
	function SetupUI()
		...
		local UndoPanel = GetControlPanel( "Undo" )
...
concommand.Add("undo",					CC_UndoLast		)
concommand.Add("gmod_undo",				CC_UndoLast		)
concommand.Add("gmod_undonum",			CC_UndoNum		)
